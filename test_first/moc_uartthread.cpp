...
static const char qt_meta_stringdata_CUartThread[] = {
    "CUartThread\0\0strBuf\0sSerialData(char*)\0"
};
...
const QMetaObjectExtraData CUartThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CUartThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CUartThread,
      qt_meta_data_CUartThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CUartThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CUartThread))

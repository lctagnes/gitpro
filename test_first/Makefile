#############################################################################
# Makefile for building: affine
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_OPENGL_SUPPORT -DQT_QML_DEBUG -DQT_DECLARATIVE_DEBUG -DQT_OPENGL_LIB -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -g -Wall -W -D_REENTRANT -fPIE $(DEFINES)
CXXFLAGS      = -pipe -g -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++ -I/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine -I/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared -I/usr/include/qt5 -I/usr/include/qt5/QtOpenGL -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -L../shared -ldemo_shared -lQt5OpenGL -L/usr/lib/i386-linux-gnu -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/main.cpp \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.cpp qrc_affine.cpp \
		moc_xform.cpp
OBJECTS       = main.o \
		xform.o \
		qrc_affine.o \
...
DIST          = /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared/shared.pri \
		...
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.pro \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.qrc \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.pro
QMAKE_TARGET  = affine
...
Makefile: /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.pro
...
dist: 
	@test -d .tmp/affine1.0.0 || mkdir -p .tmp/affine1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/affine1.0.0/ && $(COPY_FILE) --parents /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.qrc .tmp/affine1.0.0/ && $(COPY_FILE) --parents /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.h .tmp/affine1.0.0/ && $(COPY_FILE) --parents /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/main.cpp /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.cpp .tmp/affine1.0.0/ && (cd `dirname .tmp/affine1.0.0` && $(TAR) affine1.0.0.tar affine1.0.0 && $(COMPRESS) affine1.0.0.tar) && $(MOVE) `dirname .tmp/affine1.0.0`/affine1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/affine1.0.0
...
compiler_rcc_make_all: qrc_affine.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_affine.cpp
qrc_affine.cpp: /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.qrc \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.html \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.cpp \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/bg1.jpg \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.h \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared/arthurwidgets.h \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared/arthurstyle.h \
		...
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared/hoverpoints.h \
	...
	/usr/lib/i386-linux-gnu/qt5/bin/rcc -name affine /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.qrc -o qrc_affine.cpp

compiler_moc_header_make_all: moc_xform.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_xform.cpp
moc_xform.cpp: /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared/arthurwidgets.h \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared/arthurstyle.h \
		/usr/include/qt5/QtGui/QBitmap \
		/usr/include/qt5/QtGui/qbitmap.h \
		/usr/include/qt5/QtGui/qpixmap.h \
...
main.o: /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/main.cpp /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.h \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared/arthurwidgets.h \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared/arthurstyle.h \
		/usr/include/qt5/QtGui/QBitmap \
		/usr/include/qt5/QtGui/qbitmap.h \
		...
		/usr/include/qt5/QtGui/qguiapplication.h \
		/usr/include/qt5/QtGui/qinputmethod.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/main.cpp

xform.o: /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.cpp /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.h \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared/arthurwidgets.h \
		/usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/shared/arthurstyle.h \
		/usr/include/qt5/QtGui/QBitmap \
		/usr/include/qt5/QtGui/qbitmap.h \
		...
		/usr/include/qt5/QtGui/QPainter \
		/usr/include/qt5/QtGui/QPainterPath
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o xform.o /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.cpp

qrc_affine.o: qrc_affine.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_affine.o qrc_affine.cpp

moc_xform.o: moc_xform.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_xform.o moc_xform.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine || mkdir -p $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/ 


install_sources: first FORCE
	@test -d $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine || mkdir -p $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine
	-$(INSTALL_FILE) /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/main.cpp $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/
	-$(INSTALL_FILE) /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.cpp $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/
	-$(INSTALL_FILE) /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.h $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/
	-$(INSTALL_FILE) /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.qrc $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/
	-$(INSTALL_FILE) /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/affine.pro $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/
	-$(INSTALL_FILE) /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/xform.html $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/
	-$(INSTALL_FILE) /usr/local/Trolltech/QtEmbedded-4.6.3-arm/demos/affine/bg1.jpg $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/

uninstall_sources: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/bg1.jpg
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/xform.html
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/affine.pro
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/affine.qrc
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/xform.h
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/xform.cpp
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/main.cpp
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/lib/i386-linux-gnu/qt5/examples/affine/ 
